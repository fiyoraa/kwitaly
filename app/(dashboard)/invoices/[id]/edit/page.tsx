  ...
  if (loading) {
    return (
      <div className="p-8 max-w-7xl mx-auto flex items-center justify-center min-h-[50vh]">
        <div className="w-8 h-8 rounded-full border-4 border-surface-raised border-t-accent animate-spin"></div>
      </div>
    )
  }
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex items-center space-x-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-text-primary tracking-tight">Edit Invoice</h1>
          <p className="text-sm font-medium text-text-secondary mt-0.5">Perbarui detail tagihan klien ini.</p>
        </div>
      </div>
          ...
          <div className="w-full lg:w-2/5 md:sticky top-8 space-y-6">
            <div className="bg-surface rounded-2xl border border-border p-8 shadow-sm">
              ...
              <p className="text-center text-xs text-text-tertiary mt-4 font-medium">
                Pembaruan akan langsung ter-sync dengan database.
              </p>
            </div>
          </div>
        </form>
